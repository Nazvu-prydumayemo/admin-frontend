...
def main():
    """Run the PyInstaller build for the NP-Tennis Admin application."""
    project_root = Path(__file__).parent.absolute()
    dist_dir = project_root / "dist"
    build_dir = project_root / "build"
    spec_file = project_root / "NP-Tennis-Admin.spec"
    ...
    exe_name = "NP-Tennis-Admin.exe" if sys.platform == "win32" else "NP-Tennis-Admin"
